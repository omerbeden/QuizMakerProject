...
import presenter.DyPresenter;
import javax.swing.JFrame;



public class SoruDy1 extends javax.swing.JInternalFrame implements IDYForm {

    private static SoruDy1 instance =new SoruDy1();//singleton için ilk kural 111111bir
    DyPresenter presenter;
    
    private SoruDy1() {
        initComponents();
        presenter =new DyPresenter(this);
        
    }
    public static SoruDy1  getInstance(){
    ...
    private void initComponents() {
        ...
        tx_cevap = new javax.swing.JComboBox();
        ...
        tx_puan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "5", "10", "15", "20", "25", "30", "35", "40", "45", "50", " " }));

        jLabel9.setBackground(new java.awt.Color(204, 204, 204));
        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(204, 204, 204));
        jLabel9.setText("SORU PUANI:");

        tx_cevap.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "A", "B", "C", "D", " " }));

        jLabel10.setBackground(new java.awt.Color(204, 204, 204));
        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(204, 204, 204));
        jLabel10.setText("DOGRU CEVAP:");
        ...
        jLabel12.setText("SORU ID:");

        jTextField4.setBackground(new java.awt.Color(204, 204, 204));

        jButton4.setBackground(new java.awt.Color(0, 102, 102));
        jButton4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jButton4.setText("KATEGORİ L.");
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    ...
                                    .addGap(18, 18, 18)
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(tx_cevap, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(tx_zorluk, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    .addGap(28, 28, 28)
                                    .addComponent(jLabel11)
                                    .addGap(18, 18, 18)
                                    .addComponent(tx_ders, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(tx_soru, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(tx_puan, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGap(28, 28, 28))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(84, 84, 84)
...
puanaGoreListele();
    ...
    private javax.swing.JComboBox tx_cevap;
    ...
    public void dySoruEkle() {
        ...
        presenter.dySoruEkle(tx_soru.getText(),tx_a.getText(),tx_b.getText(),tx_ders.getSelectedItem(),tx_cevap.getSelectedItem(),tx_zorluk.getSelectedItem(),tx_puan.getSelectedItem());
    ...
    public void dySoruSil() {
        ...
        presenter.dySoruSil(Integer.parseInt(jTextField4.getText()));
    }

    @Override
    public void dySoruGuncelle() {
        presenter.dySoruGuncelle(tx_soru.getText(),tx_ders.getSelectedItem(),tx_cevap.getSelectedItem(),tx_zorluk.getSelectedItem(),tx_puan.getSelectedItem(),Integer.parseInt(jTextField4.getText()));
    }
